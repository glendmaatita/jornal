...
const metadata = await Bun.file(new URL("../pb_migrations/20260914_0004_sync_metadata.js", import.meta.url)).text()
const revisions = await Bun.file(new URL("../pb_migrations/20260915_0005_revision_tombstones.js", import.meta.url)).text()
