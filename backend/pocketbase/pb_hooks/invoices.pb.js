...
routerAdd("POST", "/api/jornal/invoicing/invoices/{id}/mark-paid", (event) => {
  ...
  $app.runInTransaction((tx) => {
    ...
    response = { invoice: h.invoiceResponse(invoice), payment: h.paymentResponse(payment), ledgerTransaction }
