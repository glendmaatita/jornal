...
| --- | --- | --- |
| Regression suite | `bun test` | 214 tests passed, 0 failed |
...
- Install prompt handling on login and authenticated routes, offline status/retry UI, persistent storage request, and pending-review app badge (W02–W05, W08). Shortcut routes and the share-target manifest are present but still need device acceptance (W06–W07).
